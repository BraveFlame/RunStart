...
//
//
//public class PunchingCardActivity extends AppCompatActivity {
//
...
//                    setUserView(user);
//                    //取出，用于判断是否完成任务，与上方无关
//                    PunchingCardActivity.this.user = user;
//                    break;
...
//                    List<ActivityAndMember> ps = gson.fromJson(str, new TypeToken<List<ActivityAndMember>>() {
//                    }.getType());
...
//        Intent intent = new Intent(activity, PunchingCardActivity.class);
...
//        switch (type) {
//            case 0:
//                supposed_punching_times = CommonUtils.getTwoDay(join_time) + 1;
//                break;
//            case 1:
//                supposed_punching_times = (CommonUtils.getTwoDay(join_time) + 1) * 2;
//                break;
//            case 2:
//                supposed_punching_times = CommonUtils.getTwoWeek(join_time) + 1;
//                break;
//            case 3:
//                supposed_punching_times = (CommonUtils.getTwoWeek(join_time) + 1) * 2;
//                break;
//            case 4:
//                supposed_punching_times = (CommonUtils.getTwoWeek(join_time) + 1) * 3;
//                break;
//            case 5:
//                supposed_punching_times = CommonUtils.getTwoMonth(join_time) + 1;
//                break;
//            default:
//                break;
//        }
...
//        switch (type) {
//            case 0:
//                distance = user.getWalkDistance();
//                break;
//            case 1:
//                distance = user.getRunDistance();
//                break;
//            case 2:
//                distance = user.getRideDistance();
//                break;
//            default:
//                break;
//        }
...
//        switch (frequency) {
//            case 0:
//                if (sign_in_flag < 1) return true;
//                break;
//            case 1:
//                if (sign_in_flag < 2) return true;
//                break;
//            case 2:
//                if (sign_in_flag < 1) return true;
//                break;
